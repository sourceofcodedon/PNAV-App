...
public class PathView extends View {
    ...
    private void setupBaseNodes() {
        ...
        baseNodes.put("I", new float[]{100f, 1500f});
        baseNodes.put("J", new float[]{585f, 1500f});
        baseNodes.put("K", new float[]{825f, 1500f});
        baseNodes.put("L", new float[]{100f, 1900f});
        baseNodes.put("M", new float[]{585f, 1900f});
        baseNodes.put("N", new float[]{825f, 1900f});
    }
