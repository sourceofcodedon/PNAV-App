...
public class FirstMeatMapView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firstMeatPathView.setClickableNodes(clickableNodes);
        ...
        btnGo.setOnClickListener(v -> {
            ...
            if (path == null || path.isEmpty()) {
                ...
                firstMeatPathView.startPathAnimation(path, userMarker, instructionText, currentInstructions, graph);
            }
        });
    ...
    private List<String> generateInstructions(List<String> path) {
        ...
        for (int i = 1; i < path.size() - 1; i++) {
            ...
            float[] pPrev = firstMeatPathView.getNodeCoordinates(prevNode);
            float[] pCurr = firstMeatPathView.getNodeCoordinates(currNode);
            float[] pNext = firstMeatPathView.getNodeCoordinates(nextNode);
